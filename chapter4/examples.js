...
// Let's add a few items. Each operation returns the new length of the array.
...
var person = { name: "Gabriel", age: 37, profession: "developer" };

/* Let's return the values in each key/value pair. In this context,
   a key/value pair is also known as an entry. */
console.log(Object.values(person)); //['Gabriel', 37, 'developer']
...
console.log('2019'.padStart(4, "0")); //"2016"
console.log('2019'.padEnd(3, "0")); //"2016"